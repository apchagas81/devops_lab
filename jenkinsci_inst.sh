...
echo "To run a new container, type the following command in example: sudo docker run -d -i -t --name vm-lab-jks-002 --hostname vm-lab-jks-002 -v /opt/app:/opt/app -p 8081:8080 -p 81:80 vm-lab-jks-$now /bin/bash....   "
